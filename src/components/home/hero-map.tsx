...
export function HeroMap() {
  ...
  return (
    <div
      ...
      className="relative overflow-hidden flex flex-col gap-10 px-6 py-10 md:block md:px-0 md:py-0 md:gap-0 md:h-[max(740px,calc(100vh-210px))]"
    >
      <div
      ...
      {/* graticule labels */}
      <div className="hidden md:block absolute top-3 left-24 font-plex-mono font-medium text-[10px] text-[var(--ink)]">
        28°58&apos;E
      </div>
      <div className="hidden md:block absolute top-3 right-24 font-plex-mono font-medium text-[10px] text-[var(--ink)]">
        29°06&apos;E
      </div>
      <div
        className="hidden md:block absolute top-24 left-2 font-plex-mono font-medium text-[10px] text-[var(--ink)]"
        style={{ writingMode: "vertical-rl" }}
      >
        41°01&apos;N
      </div>
      <div
        className="hidden md:block absolute bottom-24 left-2 font-plex-mono font-medium text-[10px] text-[var(--ink)]"
        style={{ writingMode: "vertical-rl" }}
      >
        40°58&apos;N
      </div>
      ...
      {/* hero */}
      <div className="relative md:absolute md:left-11 md:top-[74px] max-w-[600px]">
        <div className="font-plex-mono font-medium text-[12px] tracking-[0.16em] text-[var(--acc)]">
          {t(copy.home.legend, lang)}
        </div>
        <h1 className="mt-3.5 font-display font-semibold text-[52px] sm:text-[68px] md:text-[92px] leading-[0.98] tracking-[-0.03em] text-[var(--ink)]">
          Faruk
          <br />
          Gürbüz
        </h1>
